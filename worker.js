...
const uncommonPatterns = [
    ...
    'ABSCISSA', 'ILLUMINATION', 'CLOCKWISE', 'DIAGONAL', 'VERTICAL',
    'HORIZONTAL', 'OBELISK', 'PYRAMID', 'SCULPTURE', 'CIPHER', 'ENCRYPT', 'DECRYPT',
    'SUBSTITUTION', 'ALPHABET', 'LETTER', 'SYMBOL', 'SLOWLY',
    'DESPARATELY', 'WEAKLY', 'SCRATCHES', 'SHADOWS',
    'LAYER', 'QUESTION', 'ANSWER', 'SOLUTION', 'MYSTER', 'HIDDEN', 'COVER',
    'REVEAL', 'TRUTH', 'DECEPTION', 'MISSION', 'REDACTED', 'CLASSIFIED',
